...
Gem::Specification.new do |s|
  ...
  s.add_development_dependency(%q<rubydns>.freeze, ["~> 2.0.1".freeze])
  s.add_development_dependency(%q<nio4r>.freeze, ["~> 2.0".freeze])
  ...
  s.add_runtime_dependency(%q<simpleidn>.freeze, ["~> 0.1".freeze])
end
