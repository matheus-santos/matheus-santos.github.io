...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<kramdown>.freeze, ["= 2.3.1".freeze])
  ...
  s.add_runtime_dependency(%q<jekyll-seo-tag>.freeze, ["= 2.7.1".freeze])
  ...
  s.add_runtime_dependency(%q<nokogiri>.freeze, [">= 1.12.5".freeze, "< 2.0".freeze])
